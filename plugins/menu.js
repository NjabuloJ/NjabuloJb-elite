...
`;
      ...
      const messageOptions = {
        viewOnce: true,
        buttons: [
          { buttonId: `${prefix}men`, buttonText: { displayText: `ᴍᴇɴᴜ ᴄᴏᴍᴍᴀɴᴅꜱ` }, type: 1 },
          { buttonId: `${prefix}njabulo hello can l ask please`, buttonText: { displayText: `ɴᴊᴀʙᴜʟᴏ ᴊʙ ᴀɪ ` }, type: 1 },

  ...
  try {
    ...
    if (validCommands.includes(cmd)) {
      ...
      if (!m.quoted) {
        ...
        return gss.sendMessage(m.from, { text: '✳️ Reply to the message you want to delete', ...messageOptions });
      }
      ...
      gss.sendMessage(m.from, { text: `*${toFancyFont("Message deleted successfully")}`, ...messageOptions });
    }
  } catch (error) {
    ...
    gss.sendMessage(m.from, { text: 'An error occurred while trying to delete the message.', ...messageOptions });
  }
};

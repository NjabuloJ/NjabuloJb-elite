  ...
  try {
   ...
   const img = 'https://files.catbox.moe/84ohd5.jpg';
    ...
    if (!quoted || (quoted.mtype !== "audioMessage" && quoted.mtype !== "videoMessage")) {
     ...
     image: { url: img },
       caption: `*${toFancyFont("Yo, Njabulo Jb needs a quoted audio or video to ID, fam!*")}`,
        ...messageOptions
      }, { quoted: {
            key: {
                fromMe: false,
    ...
    try {
      ...
      image: { url: img },
       caption: `*${toFancyFont("Njbulo Jb sniffin’ out that track, hold up...*")}`, 
        ...messageOptions
       }, { quoted: {
            key: {
                fromMe: false,
    ...
    image: { url: img },
      ...
      await Matrix.sendMessage(m.from, {
        image: { url: img },
        caption: `*${toFancyFont("Aira couldn’t ID that track, fam! Try another!*")}`, 
        ...messageOptions
       }, { quoted: {
            key: {
                fromMe: false,
